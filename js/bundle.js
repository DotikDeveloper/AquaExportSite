...
function gallery(selector, passiveClass) {
  var galleryBtn = document.querySelectorAll(selector);
  galleryBtn.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.target.nextElementSibling.classList.toggle(passiveClass);
    });
  });
}
...
__webpack_require__.r(__webpack_exports__);
function menu() {
  var burgerBtn = document.querySelector('.header__menu-burger');
  var menuList = document.querySelector('.header__menu-list');
  var menuPlace = document.querySelector('.header__menu');
  burgerBtn.addEventListener('click', function () {
    if (burgerBtn.style.flexDirection == 'row') {
      burgerBtn.style.flexDirection = 'column';
      menuList.classList.add('hide');
      menuList.style.left = '-750px';
    } else {
...
/* harmony import */ var _modules_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/data */ "./#src/js/modules/data.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_data__WEBPACK_IMPORTED_MODULE_1__["default"])('.footer__date');
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_gallery__WEBPACK_IMPORTED_MODULE_4__["default"])('.content-block__button', 'hide');
});
